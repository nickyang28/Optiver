...
if __name__ == '__main__':
    ...
    # model = torch.load('../input/pretrain-models/models/2021-09-20_04-11-02_0.233773.pkl').to('cuda')
    book_dir = './data/book_test.parquet/'
    trade_dir = './data/trade_test.parquet/'
    target_file = './data/test.csv'
    model = torch.load('./models/2021-09-20_05-38-09_0.234591.pkl').to('cuda')
    model.eval()
